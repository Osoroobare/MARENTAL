        ...
        <div className="flex flex-col justify-center  px-10 md:px-16  sm:grid sm:grid-cols-2  lg:grid-cols-4 gap-10 divide-x">
          <div className="text-center">
            <div className="p-4 ">
              ...
              <h5>London</h5>
              <p className="p4">Marcos Complex,Narok Nairobi Road</p>
            </div>
          </div>
          <div className="text-center">
            <div className="p-4 ">
              ...
              <h5>Business Hour</h5>
              <p className="p4">Sun - Mon 09:00 - 20:00</p>
            </div>
          </div>
          <div className="text-center">
            <div className="p-4 ">
          ...
          <div className="text-center">
            <div className="p-4 ">
              ...
              <h5>Email Us</h5>
              <p className="p4">info@marental.co.ke</p>
            </div>
          </div>
        </div>
      </div>
